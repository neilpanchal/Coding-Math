...
// ----------------------------------------------------------------------------
float yCenter, xCenter, xAngle, yAngle, xSpeed, ySpeed, offset, xRadius, yRadius;
...
void draw() {
    ...
    float xLoc = xCenter + (float)Math.cos(xAngle) * xRadius;
    float yLoc = yCenter + (float)Math.sin(yAngle) * yRadius;
